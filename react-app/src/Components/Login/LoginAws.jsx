...
import NavbarAWS from '../NavFooter/NavbarAWS';
        ...
        <div className="flex items-center justify-center flex-grow pt-18 pb-20 bg-blue-100">
            ...
            >
                ...
                <p className="mt-4 text-sm text-center">
                    Don't have an account? <Link to='/' className="w-full bg-yellow-600 text-black font-bold px-3 py-2 rounded-md hover:bg-yellow-700 transition">Sign up</Link>
                </p>
