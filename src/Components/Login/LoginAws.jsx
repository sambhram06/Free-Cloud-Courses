...
const LoginAws = ({ setLoggedInUser }) => {
        ...
        <div className="flex items-center justify-center pt-30">
          {!isForgotPassword && !isResetPassword ? (
            <form
              ...
              className="bg-white shadow-[0px_5px_15px_rgba(0,0,0,0.3)] p-8 rounded-lg w-full max-w-sm"
            >
              ...
              <input
                ...
                className="w-full mb-4 px-4 py-1 border-0 border-b-2 border-gray-300 focus:border-black focus:outline-none transition duration-200"
                required
              />
              ...
              <p className="mt-4 text-sm text-center">
                ...
                <Link
                  to="/signupaws"
                  className="bg-yellow-600 text-black font-bold px-3 py-2 rounded-md hover:bg-yellow-700 transition"
                >
                  Sign up
                </Link>
              </p>
            ...
            <form
              ...
              className="bg-white p-8 rounded-lg shadow-[0px_5px_15px_rgba(0,0,0,0.3)] w-full max-w-sm"
            >
